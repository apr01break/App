...
<aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="control-sidebar-home-tab">
            ...
            <ul class='control-sidebar-menu'>
                <li>
                    <a href='javascript::;'>
                        ...
                        <div class="menu-info">
                            <h4 class="control-sidebar-subheading">Cumpleaños de tu amigo</h4>
            ...
            <h3 class="control-sidebar-heading">Progreso de tus cursos</h3>
            <ul class='control-sidebar-menu'>
                <li>
                    <a href='javascript::;'>
        ...
        <div class="tab-pane" id="control-sidebar-settings-tab">
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <p>
                        Aqui podras modificar tu intranet a tu gusto
                    </p>
                </div><!-- /.form-group -->
            </form>
        </div><!-- /.tab-pane -->
